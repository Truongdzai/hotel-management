...
--
CREATE DATABASE IF NOT EXISTS `xdwsquanlyhomstaykhachsan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `xdwsquanlyhomstaykhachsan`;
...
(6, 56, 8, 1, '2025-07-06 20:39:36', 3396000);
...
(1, 'Nguyễn Văn A', 'Nữ', '084302004489', '0369993018', 'vana@gmail.com', 'Trà Cú', '123'),
(2, 'Nguyễn Văn B', 'Nam', '335037912', '0362067488', 'vanb@gmail.com', '72/9A Khóm 4 phường 1, Thành phố Trà Vinh', '1234'),
...
(17, 'VIP', './anhtin/phongVip.jpg', '31-32m2', '2 người lớn, giường đôi', 1, '200000000');
...
(1, 'Hồ Mậu Hoàng Long', 'Nam', '084302004430', '06/10/2005', '0768894581', 'Số 39, Tân Định, Đại Phúc, Càng Long Trà Vinh', 'hoanglong@gmail.com', '123', 0, 'Hoạt động'),
...
(56, 37, 3, 19, 8, 1, '12/7/2025', '08:00', '20/7/2025', '', 6226000, 2830000, 3396000, 0, 'Đã trả phòng', '6h00 - 9h00', 0, '', 0, '0', 0, 0, '');
...
--
ALTER TABLE `phong`
  MODIFY `ma_phong` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
